...
import { MessageCircle, Menu, X, Bug, Briefcase } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#enterprise" className="flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-violet-deep transition-colors">
              <Briefcase className="w-4 h-4" /> Entreprises
            </a>
